...
var that = this
  ...
  render(){
    ...
    <div className="row " style={{marginLeft: '33px'}}>
        <div className="col-md-6" style={{background:'rgb(0,0,0,0.5)',width: '43%',marginTop: '29px',position:'absolute'}}>
                ...
                <input type="text" value = {this.state.items} onChange={this.item.bind(this)}placeholder="add a new item..." style={{width:'450px',height: '40px'}}/>
                    ...
                    <li className="ui-state-default">
                        <div className="checkbox" style={{marginLeft: '15px'}}>
                            <label style ={{fontSize:'25px',color:'black',fontStyle: 'italic',fontFamily:"serif"}}>
    ...
    <div style={{background:'rgb(0,0,0,0.5)', width:'40%',float:'right',marginTop: '159px',borderRadius: '5%', marginRight:'26px'}}>
